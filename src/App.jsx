...
import { ProductContext, initialState, reducer } from './components/ProductContext'
import { BasketContext, initialState1, reducer1 } from './components/BasketContext'
    ...
    //   basket.forEach(item => {
      ...
      <div className='row'>
        <ProductContext.Provider value={{ state, dispatch }}>
          <BasketContext.Provider value={{state1,dispatch1}}>
          <ProductList />
          <Basket />
